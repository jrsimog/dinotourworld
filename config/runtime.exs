...
#
#     PHX_SERVER=true bin/dinosaur_backend start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :dinosaur_backend, DinosaurBackendWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :dinosaur_backend, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :dinosaur_backend, DinosaurBackend.Mailer,
